<template>
  <main class="p-4 bg-white h-full w-full pt-6 max-w-lg mx-auto text-slate-800">
    <h1
      ...
      class="text-center text-3xl font-semibold mb-2"
    >
      Open House
    </h1>
    <div
    ...
    <div class="flex items-center justify-start mt-6 w-full rounded-lg bg-slate-50 shadow-lg p-4">
      <div
        v-if="acc.agentData.image"
        class="h-24 w-24 rounded-full overflow-hidden flex-none"
      >
        <img
